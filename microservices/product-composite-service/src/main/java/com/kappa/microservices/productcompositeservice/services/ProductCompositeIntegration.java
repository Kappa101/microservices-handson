package com.kappa.microservices.productcompositeservice.services;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.kappa.microservices.productcompositeservice.api.core.product.Product;
import com.kappa.microservices.productcompositeservice.api.core.product.ProductService;
import com.kappa.microservices.productcompositeservice.api.core.recommendation.Recommendation;
import com.kappa.microservices.productcompositeservice.api.core.recommendation.RecommendationService;
import com.kappa.microservices.productcompositeservice.api.core.review.Review;
import com.kappa.microservices.productcompositeservice.api.core.review.ReviewService;
import com.kappa.microservices.productcompositeservice.api.event.Event;
import com.kappa.microservices.productcompositeservice.util.exceptions.InvalidInputException;
import com.kappa.microservices.productcompositeservice.util.exceptions.NotFoundException;
import com.kappa.microservices.productcompositeservice.util.http.HttpErrorInfo;
...
import static com.kappa.microservices.productcompositeservice.api.event.Event.Type.CREATE;
import static com.kappa.microservices.productcompositeservice.api.event.Event.Type.DELETE;
...
//    }
    ...
    /**
     * Spring will inject a load balancer-aware filter into the WebClient.Builder bean
     * this isn't done until after the constructor runs
     * move the construction of webClient away from the constructor to this below method
     *
     * @return
     */
